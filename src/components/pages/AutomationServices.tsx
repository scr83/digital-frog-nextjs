...
export function AutomationServices() {
  ...
  const translationKey = language === 'es' ? 'serviciosAutomatizacion' : 'automationServices';
  // SEO Configuration
  const canonicalUrl = language === 'es' 
    ? 'https://digitalfrog.co/es/servicios/automatizacion'
    : 'https://digitalfrog.co/services/automation';
  const schemaData = {
...
AutomationServices.displayName = 'AutomationServices';
